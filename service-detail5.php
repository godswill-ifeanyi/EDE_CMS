...
<body>
    ...
    <section id="blog-container" class="hide">
        <div class="blogs">
            <h2>Photography/Photo Studio</h2>
            <p>Request for any of our Photography/Photo Studio Services</p>
            <div class="post hide">
                <img src="images/photo-studio.jpg" class="small-banner" alt="">
        ...
        <div class="cate hide">
            ...
            <hr>
            <a href="#">Frames/Enlargement</a>
            <hr>
            <a href="#">Event Coverage</a>
            <hr>
            <a href="#">Digital/Visa Passport</a>
            <hr>
