...
<head>
    ...
    <title>UI/UX Design | Excellent Digital Express Limited</title>
...
<body>
    ...
    <section id="course-inner" class="hide">
        <div class="overview">
            ...
            <img class="course-img" src="images/uiux.jpg" alt="">
        ...
        <h3>3 Month(s)</h3>
        <p>User interface (UI) design refers to the aesthetic elements by which people 
            interact with a product, such as buttons, icons, menu bars, typography, 
            colors, and more. User experience 
            (UX) design refers to the experience a user has when interacting with a product.
        </p>
        <h3 class="hide">Course Overview</h3>
        <p class="hide">
        Introduction, Core concepts (Visual Arts, Page Layout, etc), Typography, Color 
        theory, Planning Projects, Corel Draw, Adobe Photoshop and Final Project.
        <br><br>
        <b>This course will equip the individual with the necessary skills and 
            tool set to become a good graphics designer.
        </p>
        <hr>
        <div class="course-flex">
            <div>
                ...
                <p class="hide">
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Information Architecture</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> User Experience Research</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Interface Design</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Prototyping</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Usability Testing and Inspecting</p>
            ...
            <div>
                ...
                <p class="hide">
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Participant will become a UI/UX Guru</p>
