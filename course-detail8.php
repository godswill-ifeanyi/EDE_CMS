...
<head>
    ...
    <title>Graphics Design | Excellent Digital Express Limited</title>
...
<body>
    ...
    <section id="course-inner" class="hide">
        <div class="overview">
            ...
            <img class="course-img" src="images/graphics.jpg" alt="">
        ...
        <h3>2 Month(s)</h3>
        <p>This training course is to introduce the individual into the creative 
            world of graphics design – 
            the art of visual communication through the use of text, images and symbols.
        </p>
        ...
        <div class="course-flex">
            <div>
                ...
                <p class="hide">
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Colours and Forms</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Representation Techniques</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Image Design</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Creative Thinking</p>
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Graphic Principles</p>
            ...
            <div>
                ...
                <p class="hide">
                    <p><img src="icons/circle-check.svg" class="icons" alt=""> Participant will become a Graphics Design Guru</p>
