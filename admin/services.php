...
<body>
    ...
    <section id="interface">
        ...
        onclick="window.location.href='add-service.php'">
            Create Service
        </p>
            <table width="100%">
                <thead>
            ...
            ?>
                    <tr>
                        ...
                        <td class="edit">
                        <?php echo "<a class='btn button' href='edit-service.php?
                        service_id={$info['id']}'>Edit</a>";  ?>
                        </td>
                        <td class="edit">
                        <?php echo "<a class='btn button' onClick=\"javascript:return confirm('Are you sure to delete this data?')\"
                        href='./delete-service.php?
                        service_id={$info['id']}'>Delete</a>";  ?>
                        </td>
                    </tr>
                    <?php
