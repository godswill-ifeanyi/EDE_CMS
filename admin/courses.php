...
<body>
    <section id="menu">
        ...
        <nav class="items">
            ...
            <li class="active" onclick="window.location.href='courses.php'"><a href="courses.php"><img src="icons/form.svg" alt="" class="icons">Courses</a></li>
    ...
    <section id="interface">
        ...
        onclick="window.location.href='add-course.php'">
            Create Course
        </p>
            <table width="100%">
                <thead>
            ...
            ?>
                    <tr>
                        ...
                        <td class="active">
                        <?php echo "{$info['registered_students']}";  ?>
                        </td>
                        <td class="role">
                        <?php echo "{$info['date']}";  ?>
                        </td>
                        <td class="edit">
                        <?php echo "<a class='btn button' href='course-detail.php?
                        course_id={$info['id']}'>Course Details</a>";  ?>
                        </td>
                        <td class="edit">
                        <?php echo "<a class='btn button' href='edit-course.php?
                        course_id={$info['id']}'>Edit</a>";  ?>
                        </td>
                        <td class="edit">
                        <?php echo "<a class='btn button' onClick=\"javascript:return confirm('Are you sure to delete this data?')\"
                        href='./delete-course.php?
                        course_id={$info['id']}'>Delete</a>";  ?>
                        </td>
                    </tr>
                    <?php
