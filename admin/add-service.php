...
if (empty($photo) || empty($title) || empty($intro) || empty($category) || empty($date) ) {
    echo '<script>
            alert("Empty fields");
            window.location="./add-service.php";
            </script>';
} else {
    $sql = "INSERT INTO services (picture, title, intro, category, date) VALUES ('$photo','$title',
     '$intro', '$category', '$date')";
    ...
    <section id="interface">
        ...
        <div class="form">
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <textarea name="intro" cols="25" rows="7"></textarea><br><br>
