...
if (empty($photo) || empty($title) || empty($registered_students) || empty($date) ) {
    ...
    $sql = "INSERT INTO courses (picture, title, registered_students, date) VALUES ('$photo','$title',
     '$registered_students', '$date')";
    ...
    <section id="interface">
        ...
        <div class="form">
            <form action="#" method="post" enctype="multipart/form-data">
                ...
                <input type="text" placeholder=" Registered Students" name="registered_students"><br><br>
